...
import com.redhat.ceylon.compiler.java.runtime.metamodel.AppliedAttribute;
import com.redhat.ceylon.compiler.java.runtime.metamodel.AppliedMethod;
...
public class TypeHack {
	...
	public static <Container> void trustMeSet(
		...
		AppliedAttribute<?, ?, ?> appliedAttribute = (AppliedAttribute<?, ?, ?>) attribute;
	...
	public static <Container> Object trustMeInvoke(
		...
		AppliedMethod<?, ?, ?> appliedMethod = (AppliedMethod<?, ?, ?>) method;
